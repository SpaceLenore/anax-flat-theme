...
# LESS and CSS
LESS 		 	= style.less base.less dark.less light.less color.less typography.less colorful.less #style1.less #style2.less
...
less-lint: less
	...
	ls -l build/lint/
	@echo "\e[32m\e[1m*** TEST COMPLETED - NO ERRORS! (GOOD JOB) ***\e[0m\e[49m"
